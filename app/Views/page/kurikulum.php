...
<script>
    $(document).ready(function(){
        ...
        columns: [
            ...
            {data: 'id_kurikulum', sClass: "text-center",
                mRender: function (data, type, full) {
                    
                    html ='<button class="btn btn-sm btn-primary btn-icon mr-1 btn-edit" id="'+full['id_kurikulum']+'"  data-toggle="tooltip" data-placement="left" title="Edit Data"><i class="fas fa-edit"></i></button>';
                    html +='<button class="btn btn-sm btn-success btn-icon btn-map" id="'+full['id_kurikulum']+'"  data-toggle="tooltip" data-placement="left" title="Map Mata Pelajaran"><i class="fas fa-plus"></i></button>';
        ...
        $(document).on('click','.btn-edit',function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $('#nama').val(data.nama_kurikulum)
                    $('#id').val(data.id_kurikulum)
            ...
            $.ajax({
                ...
                success:function(respon){
                    ...
                    if(respon.berhasil){
                        ...
                        iziToast.success({
                            title: 'Berhasil',
                            message: 'Referensi Kurikulum Berhasil Dibuat',
                            position: 'topRight',
                            timeout: 5000,
                        });
