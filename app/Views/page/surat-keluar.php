      ...
      <form id="formuser" autocomplete="off">
        <div class="modal-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control"  name="tujuan" id="tujuan" placeholder="Tujuan Surat.." >
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="hidden" class="form-control"  name="jenis" id="jenis" value="Keluar">
